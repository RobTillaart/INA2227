...
{
  assertEqual(0x8000, INA2227_SHUNT_OVER_VOLTAGE);
  assertEqual(0x4000, INA2227_SHUNT_UNDER_VOLTAGE);
  assertEqual(0x2000, INA2227_BUS_OVER_VOLTAGE);
  assertEqual(0x1000, INA2227_BUS_UNDER_VOLTAGE);
  assertEqual(0x0800, INA2227_POWER_OVER_LIMIT);
  assertEqual(0x0400, INA2227_CONVERSION_READY);

  assertEqual(0x0010, INA2227_ALERT_FUNCTION_FLAG);
  assertEqual(0x0008, INA2227_CONVERSION_READY_FLAG);
  assertEqual(0x0004, INA2227_MATH_OVERFLOW_FLAG);
  assertEqual(0x0002, INA2227_ALERT_POLARITY_FLAG);
  assertEqual(0x0001, INA2227_ALERT_LATCH_ENABLE_FLAG);
